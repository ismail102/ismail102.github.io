...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateGallery() {
        ...
        const _t = thumbnails[currentIndex];
        const _list = document.getElementById('thumbnailList');
        if (_t && _list) { _list.scrollTo({ top: _t.offsetTop - _list.offsetTop - 8, behavior: 'smooth' }); }
    }
